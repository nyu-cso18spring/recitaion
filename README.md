...
2. Download the class virtual machine image [here](http://tintin.news.cs.nyu.edu/lubuntu16.04.ova). This file is fairly large (~1.5GB), so you need to be patient.
...
Please create a github account and accept the recitation invitation given in Piazza.
